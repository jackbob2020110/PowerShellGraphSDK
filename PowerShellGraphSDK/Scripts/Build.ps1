...
Task Test -depends Build {
    ...
    $testPath = Join-Path $PSScriptRoot -ChildPath "\Tests\"
    $testOutput = Join-Path $testPath -ChildPath "TestResults.unit.xml"
    Invoke-Pester $testPath -OutputFile $testOutput -OutputFormat NUnitXml
}
