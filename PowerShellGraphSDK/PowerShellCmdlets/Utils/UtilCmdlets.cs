...
namespace BC.PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    [Cmdlet(
        CmdletVerb, CmdletNoun,
        ConfirmImpact = ConfirmImpact.None)]
    public class GetADALAuthResultParameters : PSCmdlet
    {
        /// <summary>
        /// Cmdlet name's verb.
        /// </summary>
        ...
        /// Cmdlet name's noun.
        /// </summary>
        public const string CmdletNoun = "ADALAuthResult";
        ...
        protected override void ProcessRecord()
        {
            this.WriteObject(AuthUtils.LatestAdalAuthResult.ToPowerShellObject());
        }
    }
    ...
    [Cmdlet(
        CmdletVerb, CmdletNoun,
        ConfirmImpact = ConfirmImpact.None)]
    public class GetADALRefreshTokenParameters : PSCmdlet
    {
        /// <summary>
        /// Cmdlet name's verb.
        /// </summary>
        ...
        /// Cmdlet name's noun.
        /// </summary>
        public const string CmdletNoun = "ADALRefreshToken";
        ...
        protected override void ProcessRecord()
        {
            this.WriteObject(AuthUtils.RefreshAdalAuth().ToPowerShellObject());
        }
    }
